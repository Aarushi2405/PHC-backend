...
/**
 * The persistent class for the discharge_comorbid_condition database table.
 * 
 */
@Entity
@Table(name="nr.discharge_comorbid_condition")
@NamedQuery(name="DischargeComorbidCondition.findAll", query="SELECT d FROM DischargeComorbidCondition d")
public class DischargeComorbidCondition implements Serializable {
	...
	public DischargeComorbidCondition() {
	}
