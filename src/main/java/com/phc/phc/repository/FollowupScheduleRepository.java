...
//    List<String> getFollowupSchedules();
    ...
    @Query("Select u.caseDetail.caseId as caseId, u.scheduleId as scheduleId, u.followupDetails.followupId as followupId,u.followupDetails.place as place, u.caseDetail.samNum as samNum, u.caseDetail.childDemography.name as childName, m.ashaWorker.name as ashaName, m.ashaWorker.phoneNumber as ashaNumber,  u.followupDate as followupDate, u.status as status, u.type as type from FollowupsSchedule u, AshaChildMapping m where u.caseDetail.caseId=m.caseId and u.caseDetail.caseId=?1 and u.status='DONE'")
